    ...
    <>
      <div className="relative bg-[#DA291C] overflow-hidden max-w-[1920px] mx-auto">
        ...
        <div className="sm:bg-[url('/assets/images/webp/pizzanomics-bg.webp')] bg-cover lg:bg-[length:100%_100%] bg-no-repeat bg-center max-sm:bg-[url('/assets/images/webp/mobile-view.webp')]">
          <div className="sm:bg-[url('/assets/images/pizza-bg-image.webp')] max-sm:bg-mobile-layer bg-100 -mt-[207px] bg-cover bg-no-repeat bg-center min-h-[1190px] pt-[162px]">
            ...
            <div className="max-sm:bg-pi zzanomics-card bg-cover bg-no-repeat bg-center relative bg-[url('/assets/images/counter-image.webp')] md:pt-[160px] lg:pt-[320px]  max-sm:mt-[184px]">
