    ...
    return (
        <div className='relative bg-[url("/assets/images/meet-peperuney.webp")] max-sm:bg-[url("/assets/images/meet-peperuney-mobile.webp")] bg-no-repeat bg-cover bg-center max-sm:bg-bottom min-h-[2239px] max-sm:min-h-[2000px]'>
            ...
            <div className='flex max-w-[1332px] mx-auto max-[1348.98px]:flex-col-reverse  pl-0 pr-4'>
                ...
                <p className="text-[80px] relative max-lg:text-6xl max-sm:text-[52px] max-sm:leading-[52px] leading-20 text-black font-luckiest max-w-max font-outline-2">
                MEET PepeRuney
      <span className="text-[80px] max-lg:text-6xl max-sm:text-[52px] max-sm:leading-[52px] leading-20 absolute font-luckiest -top-[3px] -left-[3px] text-white">MEET PepeRuney</span>
    </p>
                    <div className='relative min-w-[720px] max-lg:min-w-0 max-w-[720px] pl-[69px] max-sm:pl-9 pr-10 max-sm:pr-4 pt-28 pb-12'>
                        ...
                        <div className='relative z-[1]'>
                            ...
                            <div className='flex items-center justify-between mt-[21px]'>
                                ...
                                <button className='hover:scale-105 transition-all duration-300 ease-line bg-[url("/assets/images/btn-bg.webp")] bg-center bg-cover bg-no-repeat font-luckiest text-white text-[28px] max-md:text-base py-[16px] px-[60px] max-md:px-6 max-md:py-2'>Manifesto </button>
                            </div>
                        </div>
                    </div>
                </div>
